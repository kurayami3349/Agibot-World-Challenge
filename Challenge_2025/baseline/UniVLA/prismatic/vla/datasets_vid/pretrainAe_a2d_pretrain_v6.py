...
from prismatic.vla.datasets_vid.alpha_base_cfg import BaseDatasetArguments, BaseDataTrainingArguments, BaseModelArguments
...
class ActionSpacePadder():
    ...
    @classmethod
    def get_space(cls, ):
        cls.space_used = cls.space_used_left + cls.space_used_right
